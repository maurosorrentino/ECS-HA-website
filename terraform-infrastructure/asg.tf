module "name_project_ecs_frontend_asg" {
  ...
  launch_template_security_groups_ids = [aws_security_group.project_name_ecs_frontend_service_sg.id, aws_security_group.project_name_ecs_task_sg.id]
...
module "name_project_ecs_backend_asg" {
  ...
  instance_profile_name               = aws_iam_instance_profile.ecs_instance_profile.name
  launch_template_security_groups_ids = [aws_security_group.project_name_ecs_backend_service_sg.id, aws_security_group.project_name_ecs_task_sg.id]
  cluster_name                        = aws_ecs_cluster.project_name_ecs_cluster.name
